...
int main(void) {
    ...
    while (1) {
        // Load the current state of the buttons and save previous state
        ...
        switch(state) {
            case START:
                ...
                drawFullScreenImageDMA(game_start);
                state = START_NODRAW;
                break;
            case START_NODRAW:
